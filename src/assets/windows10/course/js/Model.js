$(document).ready(function(){
	...
	if(resellerName != ""){
		...
		var yqlURL = protocol +"://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20xml%20where%20url%3D%22"+encodeURIComponent(file)+"%22&format=xml&callback=?";
		
		$.getJSON(yqlURL, function(xml) {
