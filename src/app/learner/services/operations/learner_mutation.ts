...
export const user_registration_mobile_otp_send = gql`
  mutation user_registration_mobile_otp_send(
    $user_id: String
    $user: String
...
export const user_registration_mobile_otp_verify = gql`
  mutation user_registration_mobile_otp_verify(
    $otp: String!
    $mobile_number: String!
  ) {
...
export const user_registration_done = gql`
  mutation user_registration_done(
    $user_id: String
    $username: String
    $password: String!
...
export const get_forgot_username_mobile_email = gql`
  mutation get_forgot_username_mobile_email(
    $type: String
    $subtype: String!
    $mobile_number: String
    $email: String
...
export const get_forgot_password_byusername = gql`
  mutation get_forgot_password_byusername($username: String) {
    get_forgot_password_byusername(username: $username) {
      message
      success
      user_id
      data {
...
export const user_registration_username_suggestion = gql`
  mutation user_registration_username_suggestion($user_id: String) {
    user_registration_username_suggestion(user_id: $user_id) {
      message
      success
      data
    }
...
export const get_forgot_password_byresetpassword = gql`
  mutation get_forgot_password_byresetpassword(
    $username: String!
    $password: String!
  ) {
...
export const get_district_details = gql`
  mutation get_district_details($country: String, $state: String) {
    get_district_details(country: $country, state: $state) {
      message
      success
      data {
        _id
...
export const get_change_password_updateprofile = gql`
  mutation get_change_password_updateprofile(
    $username: String
    $old_password: String
    $password: String
  ) {
...
export const delete_qualification = gql`
  mutation delete_qualification($user_id: String, $qualification: String) {
    delete_qualification(user_id: $user_id, qualification: $qualification) {
      success
      message
    }
  }
...
export const update_profile = gql`
  mutation update_profile(
    $user_id: String
    $is_student_or_professional: String
    $profile_img: String
...
export const update_mobile_onprofile = gql`
  mutation update_mobile_onprofile($user_id: String, $mobile_number: String) {
    update_mobile_onprofile(user_id: $user_id, mobile_number: $mobile_number) {
      message
      success
    }
  }
...
export const update_verifyotp_mobile_onprofile = gql`
  mutation update_verifyotp_mobile_onprofile(
    $user_id: String
    $mobile_number: String
    $otp: String
  ) {
...
export const update_email_onprofile = gql`
  mutation update_email_onprofile($user_id: String, $email: String) {
    update_email_onprofile(user_id: $user_id, email: $email) {
      message
      success
    }
  }
...
export const resend_otp_onprofile = gql`
  mutation resend_otp_onprofile($user_id: String) {
    resend_otp_onprofile(user_id: $user_id) {
      message
      success
    }
  }
...
export const gettopicdetail = gql`
  mutation gettopicdetail($_id: String, $module_name: String) {
    gettopicdetail(_id: $_id, module_name: $module_name) {
      data {
        topicname
      }
      success
...
export const getLevelSubCategoryData = gql`
  mutation getLevelSubCategoryData(
    $level1: [String]
    $level2: [String]
    $level3: [String]
  ) {
...
export const getCourseCategorySearch = gql`
  mutation getCourseCategorySearch(
    $category: [String]!
    $sub_category: [String]!
...
export const createGuidanceRequest = gql`
  mutation create_guidance_request(
    $name: String!
    $email_id: String!
    $created_by_ip: String!
    $course_id: String!
...
export const InsertCourseFeedback = gql`
  mutation InsertCourseFeedback(
    $user_id: String!
    $question_id: [que_dtl]
    $question_ans: [question_ans_content]
    $course_id: String
  ) {
