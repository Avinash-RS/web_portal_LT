...
export const playerstatus = gql`
  query playerstatus($course_id: String, $user_id: String, $batchid: String, $module: String, $parent: Float) {
    playerstatus(course_id: $course_id, user_id: $user_id, batchid: $batchid, module: $module, parent: $parent) {
      success
      message {
        id
        parent
...
export const getReadLeanerActivity = gql`
  query get_read_learner_activity(
    $userid: String!
    $date: String!
    $courseid: String
    $status: String
...
export const get_batchwise_learner_dashboard_data = gql`
  query get_batchwise_learner_dashboard_data(
    ...
    get_batchwise_learner_dashboard_data(
      user_id: $user_id
      request_type: $request_type
      jobroleCategoryId: $jobroleCategoryId
    ) {
...
export const getLearnerNewCourseReport = gql`
  query getLearnerNewCourseReport(
    ...
    $userid: String!
    $refresh: Boolean!
    $selflearning_totalweeks: Int!
    $colloboration_totalweeks: Int!
  ) {
    getLearnerNewCourseReport(
      batchid: $batchid
      courseid: $courseid
      userid: $userid
      refresh: $refresh
      selflearning_totalweeks: $selflearning_totalweeks
      colloboration_totalweeks: $colloboration_totalweeks
    ) {
      success
      error_msg
      message
...
export const labactivity = gql`
  mutation labactivity($username: String, $attempt_id: String) {
    labactivity(username: $username, attempt_id: $attempt_id) {
      data {
        url
        message
        errorCode
