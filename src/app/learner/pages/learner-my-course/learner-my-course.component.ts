  ...
  getEnrolledCourses(event, catagoryId, catalougeId, jobRoleCategoryId, searchName, jobroleCheck, showSkelton) {
    ...
    this.learnerService.get_learner_dashboard(this.userDetailes.user_id, this.userDetailes._id).subscribe((enrolledList: any) => {
        if (enrolledList.data.get_learner_dashboard && enrolledList.data.get_learner_dashboard.success) {
          this.enrolledCourses = enrolledList.data.get_learner_dashboard.message.enrolled_course_details;
          ...
          //   }
          // });
          const arr = enrolledList.data.get_learner_dashboard.message.enrolled_course_details.filter(item => {
          ...
          const arr1 = enrolledList.data.get_learner_dashboard.message.enrolled_course_details.filter(item => {
